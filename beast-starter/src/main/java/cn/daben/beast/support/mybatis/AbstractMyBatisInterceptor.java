...
package cn.daben.beast.support.mybatis;

import cn.daben.beast.constant.StringConst;
import cn.daben.beast.exception.BusinessException;
import cn.daben.beast.support.security.crypto.Algorithm;
...
public abstract class AbstractMyBatisInterceptor implements Interceptor {
    ...
    private Map<String, FieldEncrypt> getEncryptParamsNoCached(String mappedStatementId, Integer parameterIndex) {
        try {
            String className = CharSequenceUtil.subBefore(mappedStatementId, StringConst.DOT, true);
            String wrapperMethodName = CharSequenceUtil.subAfter(mappedStatementId, StringConst.DOT, true);
