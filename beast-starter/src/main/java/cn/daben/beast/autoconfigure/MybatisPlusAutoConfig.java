...
import cn.daben.beast.properties.MyBatisPlusExtensionProperties;
import cn.daben.beast.support.data.mybatis.MyBatisPlusMetaObjectHandler;
import cn.daben.beast.support.data.mybatis.plus.ConditionalOnEnabledDataPermission;
...
public class MybatisPlusAutoConfig extends AbstractAutoConfig {
    ...
    public MybatisPlusInterceptor mybatisPlusInterceptor(MyBatisPlusExtensionProperties properties) {
        ...
        // 数据权限插件
        ExtensionConfig.DataPermission dataPermissionProperties = properties
                .getDataPermission();
