...
@ConditionalOnProperty(prefix = PropertiesConst.CAPTCHA_BEHAVIOR, name = PropertiesConst.ENABLED, matchIfMissing = true)
public class BehaviorCaptchaAutoConfig extends AbstractAutoConfig {

    private static final Logger log = LoggerFactory.getLogger(BehaviorCaptchaAutoConfig.class);
    private final BehaviorCaptchaProperties properties;

    public BehaviorCaptchaAutoConfig(BehaviorCaptchaProperties properties) {
